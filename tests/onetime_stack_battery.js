...
let OnetimeStack = artifacts.require("OnetimeStack");
...
module.exports = async (callback) => {
  ...
  let e = null;
  let address = "0x191cd5ba79177e61922344784bb4e0ff09eb1373";
  let instance = OnetimeStack.at(address);
  ...
  payoff = await instance.payoff.call(defaultTxObj);
